...
# This recipe assumes LINODE, but it can be anything

GIT_REPOSITORY_URL = '<your_git_repository_name_here>'
LINODE_SERVER_HOSTNAME = '<hostname_or_ip_address_here>'
...
set :deploy_to,                  "/var/www/apps/<name_of_your_app>"
